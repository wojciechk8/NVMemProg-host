...
namespace LibUSB {
	...
	public delegate int hotplug_callback_fn (Context context, Device device, HotplugEvent event);
	...
	public class Context {
		...
		public int handle_events_timeout_completed (Posix.timeval tv, int* completed);
		public int handle_events ();
		public int handle_events_completed (int* completed);
		...
		public int hotplug_register_callback (HotplugEvent events, HotplugFlag flags, int vendor_id, int product_id, int dev_class, hotplug_callback_fn callback_fn, out HotplugCallbackHandle callback_handle);
		public void hotplug_deregister_callback (HotplugCallbackHandle callback_handle);
	}
	...
	[CCode (cname = "LIBUSB_CONTROL_SETUP_SIZE")]
	public const uint CONTROL_SETUP_SIZE;
	...
	public class Transfer {
		public unowned DeviceHandle dev_handle;
		public uint8 flags;
	...
	public struct HotplugCallbackHandle : int {
	}
	...
	public const int HOTPLUG_MATCH_ANY;
	...
	[Compact, CCode (cname = "struct libusb_version")]
	public class Version {
		public uint16 major;
		public uint16 minor;
		public uint16 micro;
		public uint16 nano;
		public unowned string rc;
		public unowned string describe;
	}
	
	[CCode (cname = "libusb_get_version")]
	public unowned Version get_version ();
	[CCode (cname = "libusb_has_capability")]
	public int has_capability (Capability capability);
	[CCode (cname = "libusb_setlocale")]
	public int setlocale (string locale);
	[CCode (cname = "libusb_error_name")]
	public unowned string error_name (Error errcode);
	[CCode (cname = "libusb_strerror")]
	public unowned string strerror (Error errcode);
}
